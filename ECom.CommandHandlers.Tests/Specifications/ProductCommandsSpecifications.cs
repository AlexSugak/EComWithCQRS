...
//                Expect = new[] { new ProductAdded(TimeProvider.Now, 1, _productId, "Pants", 12) }
//            };
...
//            {
//                Given = new[] { new ProductAdded(TimeProvider.Now, 1, _productId, "Shirt", 11) },
...
//                Given = new IEvent[] 
//                                { 
//                                    new ProductAdded(TimeProvider.Now, 1, _productId, "Shirt", 11), 
